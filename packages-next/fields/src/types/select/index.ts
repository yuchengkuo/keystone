...
export type SelectFieldExperimentalConfig<
  TGeneratedListTypes extends BaseGeneratedListTypes
> = FieldConfig<TGeneratedListTypes> &
  SelectOptions & {
    ui?: {
...
export const selectExperimental = <TGeneratedListTypes extends BaseGeneratedListTypes>(
  config: SelectFieldExperimentalConfig<TGeneratedListTypes>
) => {

...
export type ExperimentFieldType<
...
> = {
  dbField: TDBField;
  input?: {
    uniqueWhere?: FieldInputArg<DBFieldFilters<TDBField>, UniqueFilterArg>;
  ...
  output: MaybeFunction<
    [types: Record<string, TypesForList>],
    tsgql.OutputField<
      {
        id: string;
...
export function fieldType<TDBField extends DBField>(dbField: TDBField) {
  ...
  >(stuff: {
    ...
    output: MaybeFunction<
      ...
      >
    >;
  }): ExperimentFieldType<TDBField, CreateArg, UpdateArg, FilterArg, UniqueFilterArg> {
...
export type ListForExperiment = {
  pluralGraphQLName: string;
  fields: Record<
    string,
    ExperimentFieldType<DBField, tsgql.Arg<any, any>, tsgql.Arg<any, any>, tsgql.Arg<any, any>>
  >;
};
